...
router.post('/api/posts', validatePost, async(req, res) => {
...
router.post('/api/posts/:id/like', validateLikes, async (req, res) => {
...
router.post('/api/posts/:id/comment', validateComments, async (req, res) => {
    const { id } = req.params
    const author = req.user
    const data = { 
        text: req.body.text,
